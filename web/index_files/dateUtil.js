...
//Date 객체를 01-01-2007 형식문자열로변환
function getDateStrFromDateObjectUSA(dateObject){
	var str = null;
	var month = dateObject.getMonth() + 1;
	var day = dateObject.getDate();
	...
	str = month + " / " + day +" / " +dateObject.getFullYear();
	return str;

}

//Date 객체를HH:mm:ss 형식문자열로변환
function getTimeStrFromDateObjectUSA(dateObject){
	var str = null;
