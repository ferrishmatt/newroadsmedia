...
class SinclairBroadcastGroup2CrawlerCommand extends BaseCrawler
{
    protected function configure()
    {
        $this
            ->setName('jj:sinclair-broadcast-group2')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $baseUrl = 'https://sbgtv-openhire.silkroad.com/api/index.cfm?fuseaction=app.getJobListings&LANGUAGE=en&FORMAT=xml&VERSION=1&KEYWORD=&JOBPLACEMENT=external';
        $url     = $baseUrl;
